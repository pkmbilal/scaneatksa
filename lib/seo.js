...
// Google Analytics 4 measurement ID. Public by design: it's embedded in the
// gtag script URL on every page, so it isn't a secret.
export const GA_MEASUREMENT_ID = "G-8QGFJ309BN";
