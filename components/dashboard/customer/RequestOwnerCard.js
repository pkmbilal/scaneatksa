  ...
  return (
    <div className="flex flex-col gap-4 rounded-xl border border-gray-200 p-4 dark:border-gray-800 md:flex-row md:items-center md:justify-between md:gap-3">
      <div className="min-w-0">
        <p className="text-xs text-gray-500 dark:text-gray-400">{t('requestOwnerCard.quickAction')}</p>
        <p className="font-semibold text-gray-800 dark:text-white/90">{t('requestOwnerCard.title')}</p>
        <p className="truncate text-sm text-gray-500 dark:text-gray-400">
          {t('requestOwnerCard.description')}
        </p>
      </div>
