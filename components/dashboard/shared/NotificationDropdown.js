  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="!fixed left-1/2 top-[72px] !mt-0 flex max-h-[480px] w-[calc(100vw-2rem)] max-w-[361px] -translate-x-1/2 flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark lg:!absolute lg:left-auto lg:top-auto lg:end-0 lg:!mt-[17px] lg:w-[361px] lg:max-w-none lg:translate-x-0"
      >
